...
$pdf->Image(APP . WEBROOT_DIR . '/content/'.Configure::read('Settings.site_id').'/pdf/images/Ad300x250_2.jpg', 110, 115, 88, 62, 'JPG', 'http://www.tcpdf.org', '', true, 150, '', false, false, 1, false, false, false);
