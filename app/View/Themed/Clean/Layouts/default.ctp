...
<head>
  ...
  ================================================== -->
	...
	<!-- Favicons
	================================================== -->
	<link rel="shortcut icon" href="/theme/clean/images/favicon.ico">
	<link rel="apple-touch-icon" href="/theme/clean/images/apple-touch-icon.png">
	<link rel="apple-touch-icon" sizes="72x72" href="/theme/clean/images/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="114x114" href="/theme/clean/images/apple-touch-icon-114x114.png">
...
<a href="#top" id="toTop">&#8593;</a>
	...
	<script src="/theme/clean/javascripts/jquery.waitforimages.js"></script>
	<script src="/theme/clean/javascripts/jquery.cycle2.min.js"></script>
	<script src="/theme/clean/javascripts/jquery.cycle2.tile.min.js"></script>
	<script src="/theme/clean/javascripts/jcarousellite_1.0.1.min.js"></script>
	<script src="/theme/clean/javascripts/jquery.tweet.js"></script>
	

	<script src="/theme/clean/javascripts/main_func.js"></script>
	<script src="/theme/clean/javascripts/home_func.js"></script>
