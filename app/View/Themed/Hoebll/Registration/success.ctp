<div class="grid_12" id="body-content">
    ...
    <p><?=$shop['Order']['first_name'];?>,<br><br>&nbsp;&nbsp;Now that wasn't so bad was it? Now you will still need to fill out 
        ...
        sure you have those documents. If you used "Pay At The Field" you will need to pay before your Player(s) will be eligible. 
        If you used PayPal it can take some time before we get the notification of Payment. Once we get this it will automatically 
        update and activate your players. 
    </p>
    </div>
</div>
