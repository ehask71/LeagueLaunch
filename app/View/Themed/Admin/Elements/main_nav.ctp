<ul id="menu">
	...
	<ul>
	    <li><?php echo $this->html->link(__('Add New') . '<span class="icon7"></span>', array('prefix' => 'admin', 'controller' => 'forms','action' => 'new'), array('escape' => FALSE)); ?></li>
	</ul>
    </li>
    <li><?php echo $this->html->link(__('Forms') . '<span class="icon2"></span>', array('prefix' => 'admin', 'controller' => 'forms'), array('escape' => FALSE)); ?></li>
