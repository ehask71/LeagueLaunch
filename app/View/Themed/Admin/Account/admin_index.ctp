            ...
            <div class="block_in">
                <?php
                    echo $this->Form->create('Account', array(
                        'url' => array_merge(array('controller' => 'account', 'action' => 'index'), $this->params['pass'])
                    ));
                        ...
                        if (count($users) > 0) {
                            foreach ($users AS $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php
                        echo $this->Html->link('View', '/admin/account/view/' . $row['Account']['id'], array('class' => 'button blue'));
                                ?>
                                        <?php
                                        echo $this->Html->link('Add Player', '/admin/account/addplayer/' . $row['Account']['id'], array('class' => 'button green'));
                                        ?>
                                    </td>
                                </tr>
                                <?php
