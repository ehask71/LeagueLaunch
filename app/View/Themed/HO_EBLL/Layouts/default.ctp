...
<link rel="stylesheet" type="text/css" href="../common/css/960.css" />
<link rel="stylesheet" type="text/css" href="../common/css/social.css"/>
<link rel="stylesheet" type="text/css" href="ebll/css/style.css" />
<!-- begin JS -->
</head>
...
<div class="container_16" id="body-container">
    ...
    <header>
        <div class="grid_6" >
        	<div id="sub-nav">
            	<ul id="top-nav">
                	<li><a href="/login.php" title="Login to {SITENAME}">LOGIN</a></li>
                    <li><a href="/signup.php" title="Sign Up with {SITENAME}">SIGNUP</a></li>
                    <li><a href="contact.php" title="Contact {SITENAME}">CONTACT</a></li>
                </ul>
            </div>
            <div class="clear"></div>
